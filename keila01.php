<!DOCTYPE html>
    <html lang="en">
        ...
        <link href="https://fonts.cdnfonts.com/css/ningst-sparkle" rel="stylesheet">
            ...
            <div class="jumbotron text-center" style="background-color: rgb(255, 225, 209);">
                <h1 class="display-4" style="font-family:'Apes On Parade', sans-serif; color: black">Studio Ghibli-Peliculas</h1>
                <?php 
                $username = "root";
                $password = "";
